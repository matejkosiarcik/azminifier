...
removeHiddenDirectories node_modules
removeHiddenFiles node_modules
...
# TODO: Install jq and remove these unecessary keys
...
# TODO: Add back YAML and JSON minification (probably using this package)
